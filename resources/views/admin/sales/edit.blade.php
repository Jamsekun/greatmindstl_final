...
<ol class="breadcrumb">
	...
	<li>Sales</li>
	<li class="active">Edit Sales Information</li>
</ol>
@endsection
            ...
            <div class="panel-body">
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade in active">
                        <form class="form-horizontal" id="form-sales_information" method="POST" action="{{ route('admin.sales.update', $model->id) }}">
                            @csrf
                                    ...
                                    <select name="station" class="form-control">
                                        ...
                                        @foreach ($stations as $station)
                                            @can("station.{$station->name}")
                                                <option value="{{ $station->name }}" {{ $model->station == $station->name ? 'selected' : '' }}>{{ $station->value }}</option>
                                            @endcan
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <select name="field_coordinator" class="form-control">
                                        ...
                                        @foreach ($field_coordinators as $field_coordinator)
                                            <option value="{{ $field_coordinator->value }}" {{ $model->field_coordinator == $field_coordinator->value ? 'selected' : '' }}>{{ $field_coordinator->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="total_gross_pay" value="{{ $model->total_gross_pay }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="total_net" value="{{ $model->total_net }}" readonly>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label">Created By/At</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Updated By/At</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="amount" value="{{ $model->updated_by }}" disabled>
                                </div>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="amount" value="{{ $model->updated_at }}" disabled>
                                </div>
                            </div>
...
$(function (namespace, $) {
    ...
    p.SalesItems = function (o) {
        axios({
            method: 'POST',
            url: '{{ route('admin.sales.items', $model->id) }}'
            ...
            beforeChange: function (src, changes) {
                ...
                if(changes == 'edit' || changes == 'Autofill.fill') {
                    _.forEach(src, function (item) {
                        ...
                        var data = ht.getSourceDataAtRow(row);
