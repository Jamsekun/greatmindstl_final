...
<ol class="breadcrumb">
	...
	<li class="active">Edit Lottery Results</li>
</ol>
@endsection
            ...
            <div class="panel-body">
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade in active">
                        <form class="form-horizontal" id="form-lottery_results" method="POST" action="{{ route('admin.lottery_results.update', $model->id) }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="date" value="{{ $model->date }}" data-input="datepicker" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group pad-ver">
			                    ...
			                    <div class="col-md-6">
			                        <div class="input-group date">
                                        <input type="text" class="form-control" name="draw_time" value="{{ Carbon::createFromFormat('H:i:s', $model->draw_time)->format('g:i A') }}" data-input="timepicker">
                            ...
                            <div class="form-group">
                                ...
                                @php
                                	$numbers = array_map('intval', json_decode($model->result, true));
                                @endphp


                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="number_1" value="{{ $numbers[0] }}" maxlength="2" style="margin-bottom: 5px;" autocomplete="off">
                                </div>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="number_2" value="{{ $numbers[1] }}" maxlength="2" style="margin-bottom: 5px;" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="tally_sheet" value="{{ $model->tally_sheet }}" autocomplete="off">
                                </div>
                            </div>
			                ...
			                <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="amount" value="{{ $model->created_by }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="amount" value="{{ $model->created_at }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="updated_by" value="{{ $model->updated_by }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="updated_at" value="{{ $model->updated_at }}" disabled>
                                </div>
                            </div>
...
$(function (namespace, $) {
    ...
    p._Winners = function () {
    	axios({
            method: 'POST',
            url: '{{ route('admin.lottery_results.winners', $model->id) }}',
             ...
             _.forEach(data, function (row, key) {
             	...
             	$('[name="lottery_results_winners[' + key + '][agent]"]').append(
             		'<option value="' + row.id + '">' + row.employee_number + ': ' + row.first_name + ' ' + row.last_name + '<option>'
             	);

             	$('[name="lottery_results_winners[' + key + '][amount]"]').val(
             		row.amount
             	);
             })
    ...
    p._validate = function () {
        ...
        $('#btn-lottery_results').click(function (e) {
            form.submit();
        })
    }
