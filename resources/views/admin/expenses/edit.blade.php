            ...
            <div class="panel-body">
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade in active">
                        <form class="form-horizontal" id="form-expenses_information" method="POST" action="{{ route('admin.expenses.update', $model->id) }}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="total_amount" value="{{ $model->total_amount }}" readonly>
                                </div>
                            </div>
...
$(function (namespace, $) {
    ...
    p.ExpensesItems = function (o) {
        axios({
            method: 'POST',
            url: '{{ route('admin.expenses.items', $model->id) }}',
